...
for epoch in range(epochs):
    ...
    for xtrain_set in tqdm(range(int(filenum / fileset))): #(filenum:314)/(fileset:2)=157
        ...
        for ll in range(fileset):
            # 入力データとラベルデータを読み込む
            input_data = np.loadtxt("/home/user_05/program/input_data/R_top_4ele_0.1lam_sna10000_MATLAB/R_1_"+str(ll+fileplus)+'.csv', delimiter=",")  # 入力データ (30000, 7)
            label_data = np.loadtxt("/home/user_05/program/label_data/d_top_4ele_0.1lam_sna10000_MATLAB_01/d_1per_01_"+str(ll+fileplus)+'.csv',delimiter=",")  # 教師データ (30000, 995)

            #input_data_norm = input_data / np.linalg.norm(input_data, axis=1, keepdims=True)
...
#モデルの保存
model.save('/home/user_05/program/model_save_top_3000node_MATLAB_0.1lam_sna10000_4ele_MATLAB_index') #モデルと重みの保存
#重みの保存
model.save_weights("/home/user_05/program/weight_datanumtop_3000node_MATLAB_0.1lam_sna10000_4ele_MATLAB_index.h5", save_format="h5")    
# モデルの概要を出力
model.summary()
...
ax.set_xlabel('epoch')
#plt.show()
fig.savefig('/home/user_05/d_loss_TandA/d_loss_top_TandA_3000node_sna10000_4ele_MATLAB_index.png')
...
#plt.show()
fig2.savefig('/home/user_05/d_accuracy_TandA/d_accuracy_top_TandA_3000node_sna10000_4ele_MATLAB_index.png')
...
#plt.show()
fig3.savefig('/home/user_05/d_loss_T/d_loss_top_3000node_sna10000_4ele_MATLAB_index.png')
...
#plt.show()
fig4.savefig('/home/user_05/d_accuracy_T/d_accuracy_top_3000node_sna10000_4ele_MATLAB_index.png')
"""
# 訓練データの予測精度
fig5 = plt.figure()
