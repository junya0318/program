...
"------------------------到来角度---------------------"
new_model = tf.keras.models.load_model('/home/user_05/program/model_save_datanum10per_6000node_75')#

new_model.compile(metrics=['accuracy'])#optimizer='Adam',
                    #loss = 'BinaryCrossentropy',
                    #)
SINRpred = []
for theta in tqdm(range(1000)):#00)):#0000)):
...
with open('/home/user_05/program/cdf_d10_100lam_6000node_75_75.csv', 'w', newline="") as f:
