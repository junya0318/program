...
for epoch in range(epochs):
    ...
    for xtrain_set in tqdm(range(int(filenum / fileset))): #(filenum:314)/(fileset:2)=157
        ...
        for ll in range(fileset):
            # 入力データとラベルデータを読み込む
            input_data = np.loadtxt("/home/user_05/program/DoA_estimation_sorted_8ele_50per_theta/DoA_50_"+str(ll+fileplus)+'.csv', delimiter=",")  # 入力データ (7, 30000)
            label_data = np.loadtxt("/home/user_05/program/d_optimal_estimation_sorted_8ele_90_01/d_50per_01_"+str(ll+fileplus)+'.csv',delimiter=",")  # 教師データ (995, 30000)
...
#モデルの保存
model.save('model_save_50per_3000node_estimation_8ele_sorted_ver2') #モデルと重みの保存
#重みの保存
model.save_weights("weight_datanum50per_3000node_estimation_8ele_sorted_ver2.h5", save_format="h5")    
# モデルの概要を出力
model.summary()
...
ax.set_xlabel('epoch')
#plt.show()
fig.savefig('/home/user_05/d_accuracy_T/d_loss_TandA_3000_estimation_8ele_sorted.png')
...
#plt.show()
fig2.savefig('/home/user_05/d_accuracy_T/d_accuracy_TandA_3000_estimation_8ele_sorted.png')
...
#plt.show()
fig3.savefig('/home/user_05/d_accuracy_T/d_loss_3000_estimation_8ele_sorted.png')
...
#plt.show()
fig4.savefig('/home/user_05/d_accuracy_T/d_accuracy_3000_estimation_8ele_sorted')