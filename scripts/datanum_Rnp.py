...
tau = [0, tau_a, tau_b, tau_c, tau_d] #, tau_g, tau_h, tau_e, tau_f
...
for ll in tqdm(range(0,100)):
    ...
    for mm in range(thetasize_jammer1):
        ...
        for nn in range(thetasize_jammer2):
            ...
            #-------パラメータ初期設定------------
            d = [(lam/3)*(n+1) for n in range(0,element_step-1)]#入力パラメータ取得する際の素子間隔
            ...
            xin1_tau = [xin1, xin1_taua, xin1_taub, xin1_tauc, xin1_taud]# , xin1_taug, xin1_tauh, xin1_taue, xin1_tauf
            ...
            xin2_tau = [xin2, xin2_taua, xin2_taub, xin2_tauc, xin2_taud] #( x2,x3(t+τ3　),x4(t+τ4) ), xin2_taug, xin2_tauh, xin2_taue, xin2_tauf
