...
model = MLP(6000, 6000, 6000, 6000, 995)
lam = 0.1
...
"------------------------到来角度---------------------"
new_model = tf.keras.models.load_model('/home/user_05/program/model_save_datanum5per_6000node')#
...
with open('/home/user_05/program/cdf_d_50_100lam_2000node/cdf_d50_100lam_2000node_theta_ver3.csv', 'w', newline="") as f:
